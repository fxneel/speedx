...
$.parser={auto:true,onComplete:function(_1){
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination",
				...
				"progressbar", "tree", "combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
},beforePageText:"Pag",afterPageText:"of {pages}",displayMsg:"Exibindo {from} to {to} of {total} items",nav:{first:{iconCls:"pagination-first",handler:function(){
